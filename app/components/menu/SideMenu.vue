  ...
  <aside class="dock">
    ...
    <div class="dock-body">
      ...
      <ul class="dock-nav">
        ...
        <li>
          <NuxtLink :class="{ 'router-link-active': isVimeoActive }" to="/vimeo/showcase">
            <NuxtIcon name="mdi:vimeo" size="17"/>
            <span>Vimeo</span>
          </NuxtLink>
        </li>
        <li>
          <NuxtLink :class="{ 'router-link-active': isTimelineActive }" to="/timeline">
      ...
      <ul class="dock-nav">
        <li>
          <NuxtLink :class="{ 'router-link-active': isConvertActive }" to="/convert/pitch">
